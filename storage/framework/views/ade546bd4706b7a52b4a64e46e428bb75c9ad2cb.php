...
<p style="margin: 0; font-size: 14px; text-align: center; mso-line-height-alt: 22.5px;"> <span style="font-size:15px;">
    ...
    following person with the <?php echo e($data['fullname']); ?>  has complete a course in
    <?php echo e($data['coursename']); ?> is request for his/her certificate with the the <?php echo e($data['unique_code']); ?> click
...
<?php /**PATH C:\xampp\htdocs\solution_tmc_work\tmc_instutute_recent\resources\views/mail/certiadmin.blade.php ENDPATH**/ ?>