...
<p style="margin: 0; font-size: 14px; text-align: center; mso-line-height-alt: 22.5px;"><span style="font-size:15px;"> <span style="color:#0b1560;"><strong><span style="">Dear <?php echo e($data['fullname']); ?>, </span></strong></span> thank you for completing  <?php echo e($data['coursename']); ?>

    kindly know that your certificate will be available will be ready for download in the next 48 hours.</span></p>
</div>
</div>
</td>
</tr>
...
<?php /**PATH C:\xampp\htdocs\solution_tmc_work\tmc_instutute_recent\resources\views/mail/candidate.blade.php ENDPATH**/ ?>