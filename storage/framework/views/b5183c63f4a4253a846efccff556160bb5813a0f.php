...
<div align="left" class="alignment" style="line-height:10px"><img alt="" src="https://res.cloudinary.com/the-morgans-consortium/image/upload/v1659435270/Tmc%20institute/TMC_Institute_logo_kpv3d4.jpg" style="display: block; height: auto; border: 0; width: 151px; max-width: 100%;" title="Alternate text" width="151"/></div>
</td>
</tr>
</table>
</td>
...
<!--<![endif]-->
<div class="menu-trigger" style="display:none;max-height:0px;max-width:0px;font-size:0px;overflow:hidden;"></div>
...
<![endif]--><span class="label" style="padding-top:5px;padding-bottom:5px;padding-left:15px;padding-right:20px;display:inline;font-family:Montserrat, Trebuchet MS, Lucida Grande, Lucida Sans Unicode, Lucida Sans, Tahoma, sans-serif;font-size:16px;color:false;letter-spacing:normal;"></span>
<!--[if mso]></td><td style="padding-top:5px;padding-right:20px;padding-bottom:5px;padding-left:15px"><![endif]--><span class="label" style="padding-top:5px;padding-bottom:5px;padding-left:15px;padding-right:20px;display:inline;font-family:Montserrat, Trebuchet MS, Lucida Grande, Lucida Sans Unicode, Lucida Sans, Tahoma, sans-serif;font-size:16px;color:false;letter-spacing:normal;"></span>
<!--[if mso]></td><td style="padding-top:5px;padding-right:20px;padding-bottom:5px;padding-left:15px"><![endif]--><span class="label" style="padding-top:5px;padding-bottom:5px;padding-left:15px;padding-right:20px;display:inline;font-family:Montserrat, Trebuchet MS, Lucida Grande, Lucida Sans Unicode, Lucida Sans, Tahoma, sans-serif;font-size:16px;color:false;letter-spacing:normal;"></span>
...
<p style="margin: 0; font-size: 14px;">Hi <strong><?php echo e($data['fullname']); ?></strong>,</p>
</div>
</div>
</td>
</tr>
...
<p style="margin: 0; font-size: 14px;"><strong><span style="font-size:32px;">Welcome Aboard!</span></strong></p>
</div>
</div>
</td>
</tr>
...
<p style="margin: 0; font-size: 14px;">We are excited to have you on our platform. please, click the button below to activate your account.</p>
</div>
</div>
</td>
</tr>
...
<tr>
    <td class="pad" style="padding-bottom:25px;padding-left:25px;padding-right:25px;padding-top:10px;">
        <div style="font-family: sans-serif">
        <div class="txtTinyMce-wrapper" style="font-size: 12px; mso-line-height-alt: 18px; color: #393d47; line-height: 1.5; font-family: Montserrat, Trebuchet MS, Lucida Grande, Lucida Sans Unicode, Lucida Sans, Tahoma, sans-serif;">
        <p style="margin: 0; font-size: 14px;">Thank you for partnering with us.</p>
        </div>
        <div class="txtTinyMce-wrapper" style="font-size: 12px; mso-line-height-alt: 18px; color: #393d47; line-height: 1.5; font-family: Montserrat, Trebuchet MS, Lucida Grande, Lucida Sans Unicode, Lucida Sans, Tahoma, sans-serif;">
            <p style="margin: 0; font-size: 14px;"><strong>TMC Institute Team.</strong></p>
            </div>
        </div>
    </td>
</tr>
...
<div align="center" class="alignment" style="line-height:10px">
    <img  src="https://res.cloudinary.com/the-morgans-consortium/image/upload/v1660383782/Tmc%20institute/Image_1_rxdm0t.png" style="display: block; height: auto; border: 0; width: 330px; max-width: 100%;" title="Alternate text" width="330"/>
</div>
</td>
</tr>
</table>
...
<table align="center" border="0" cellpadding="0" cellspacing="0" class="row row-3" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; background-color: #ffffff; background-image: url('images/Background.png'); background-position: top center; background-repeat: no-repeat;" width="100%">
<tbody>
<tr>
<td>
...
<?php /**PATH C:\xampp\htdocs\tmc_solution\tmc_instutute_recent\resources\views/mail/index.blade.php ENDPATH**/ ?>