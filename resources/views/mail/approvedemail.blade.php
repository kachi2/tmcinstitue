...
<div align="left" class="alignment" style="line-height:10px"><img src="https://res.cloudinary.com/the-morgans-consortium/image/upload/v1659435270/Tmc%20institute/TMC_Institute_logo_kpv3d4.jpg" style="display: block; height: auto; border: 0; width: 105px; max-width: 100%;" title="Alternate text" width="105"/></div>
</td>
</tr>
</table>
</td>
...
{{--  <p style="margin: 0; font-size: 16px; text-align: center;"><span style="font-size:42px;"><strong>HI JAMES</strong></span></p>  --}}
</div>
</div>
</td>
</tr>
...
<p style="margin: 0; font-size: 14px; text-align: center; mso-line-height-alt: 22.5px;"><span style="font-size:15px;"> <span style="color:#0b1560;"><strong><span style="">Dear {{ $data['fullname'] }} </span></strong></span> your certificate with code {{ $data['unique_code'] }}  has been Approved Thank you </span></p>
</div>
</div>
</td>
</tr>
...
<a href="#" style="text-decoration:none;display:inline-block;color:#ffffff;background-color:#0b1560;border-radius:4px;width:auto;border-top:1px solid #0b1560;font-weight:undefined;border-right:1px solid #0b1560;border-bottom:1px solid #0b1560;border-left:1px solid #0b1560;padding-top:10px;padding-bottom:10px;font-family:Montserrat, Trebuchet MS, Lucida Grande, Lucida Sans Unicode, Lucida Sans, Tahoma, sans-serif;text-align:center;mso-border-alt:none;word-break:keep-all;" target="_blank"><span style="padding-left:60px;padding-right:55px;font-size:16px;display:inline-block;letter-spacing:normal;"><span style="margin: 0; word-break: break-word; line-height: 32px;">CHANGE CHECK-IN</span></span></a>
</div>
</td>
</tr>
</table>  --}}
