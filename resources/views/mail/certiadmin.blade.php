...
<div align="left" class="alignment" style="line-height:10px"><img alt="Alternate text" src="https://res.cloudinary.com/the-morgans-consortium/image/upload/v1659435270/Tmc%20institute/TMC_Institute_logo_kpv3d4.jpg" style="display: block; height: auto; border: 0; width: 105px; max-width: 100%;" title="Alternate text" width="105"/></div>
</td>
</tr>
</table>
</td>
...
<div style="font-family: sans-serif">
<div class="txtTinyMce-wrapper" style="font-size: 12px; font-family: Montserrat, Trebuchet MS, Lucida Grande, Lucida Sans Unicode, Lucida Sans, Tahoma, sans-serif; mso-line-height-alt: 14.399999999999999px; color: #0b1560; line-height: 1.2;">
{{--  <p style="margin: 0; font-size: 16px; text-align: center;"><span style="font-size:42px;"><strong>{{ $data['fullname'] }}</strong></span></p>  --}}
</div>
</div>
</td>
</tr>
...
<p style="margin: 0; font-size: 14px; text-align: center; mso-line-height-alt: 22.5px;"> <span style="font-size:15px;">
    <span style="color:#0b1560;"><strong><span style="">The</span></strong></span>
    following person with the {{ $data['fullname'] }}  has complete a course in
    {{ $data['coursename'] }} is request for his/her certificate with the the {{ $data['unique_code'] }} click
    on the button to vaildate
</span></p>
</div>
</div>
</td>
...
<table border="0" cellpadding="0" cellspacing="0" class="button_block block-3" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt;" width="100%">
    ...
    {{--  <a href="https://tmcinstitute.com/result/admin/{{ $data['unique_code'] }}/{{ $data['coursename'] }}" style="text-decoration:none;display:inline-block;color:#ffffff;background-color:#0b1560;border-radius:4px;width:auto;border-top:1px solid #0b1560;font-weight:undefined;border-right:1px solid #0b1560;border-bottom:1px solid #0b1560;border-left:1px solid #0b1560;padding-top:10px;padding-bottom:10px;font-family:Montserrat, Trebuchet MS, Lucida Grande, Lucida Sans Unicode, Lucida Sans, Tahoma, sans-serif;text-align:center;mso-border-alt:none;word-break:keep-all;" target="_blank"><span style="padding-left:60px;padding-right:55px;font-size:16px;display:inline-block;letter-spacing:normal;"><span style="margin: 0; word-break: break-word; line-height: 32px;">CLICK HERE</span></span></a>  --}}
    <a href="https://tmcinstitute.com/adminlogin" style="text-decoration:none;display:inline-block;color:#ffffff;background-color:#0b1560;border-radius:4px;width:auto;border-top:1px solid #0b1560;font-weight:undefined;border-right:1px solid #0b1560;border-bottom:1px solid #0b1560;border-left:1px solid #0b1560;padding-top:10px;padding-bottom:10px;font-family:Montserrat, Trebuchet MS, Lucida Grande, Lucida Sans Unicode, Lucida Sans, Tahoma, sans-serif;text-align:center;mso-border-alt:none;word-break:keep-all;" target="_blank"><span style="padding-left:60px;padding-right:55px;font-size:16px;display:inline-block;letter-spacing:normal;"><span style="margin: 0; word-break: break-word; line-height: 32px;">CLICK HERE</span></span></a>
